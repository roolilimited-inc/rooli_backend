...
export class DestinationBuilder {
  constructor(private platformRules: PlatformRulesService, private prisma: PrismaService) {}
...
/**
  ...
  async preparePayloads(
    ...
    dto.overrides?.forEach((o) => overrideMap.set(o.socialProfileId, o.content));
    ...
    const mediaStub = dto.mediaIds ? new Array(dto.mediaIds.length).fill({}) : [];
